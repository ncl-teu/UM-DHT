...
//private:
    ...
    virtual void routingInit();

    virtual void routingDeinit();
     ...
     */
    virtual int routingBucketIndex(const OverlayKey& key, bool firstOnLayer = false);
     ...
     */
    virtual KademliaBucket* routingBucket(const OverlayKey& key, bool ensure);
     ...
     */
    virtual bool routingAdd(const NodeHandle& handle, bool isAlive,
